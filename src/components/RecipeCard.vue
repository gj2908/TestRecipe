...
<!--
CHALLENGE: Use the recipe object prop passed in from the parent
           to populate the recipe Title, cooking time, serving
           amount, key ingredients using {{ text interpolation }}
REMINDER: We aren't listing out each key ingredient, just a the total
          number. What built-in JavaScript function does that for us?
-->
    <div class="quickview">
      <h1>{{ recipe.title }}</h1>
      <div class="details">
